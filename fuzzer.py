...
class Fuzzer():
    ...
    def fuzz_with_dict(self, base_url, client, generator, reporter, wordlist=None, verbose=False):
        ...
        spinner =  Spinner()
        spinner.print_header("Endpoint Discovering", "🌐")
        ...
        # Start Fuzzing magic
        spinner =  Spinner()
        spinner.print_header("Endpoint Fuzzing", "🌐")
